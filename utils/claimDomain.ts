...
export function lensVoiceGuidance(lens: string): string {
  ...
  if (lens === "Emotional Intelligence") {
    return [
      ...
      "Spokenness: Would someone actually say this aloud? Internal may use boundary/leverage; surface should sound human.",
      "DISCOVERY DENSITY (craft, not routing): what sentence will the reader remember tomorrow? Not the thesis — the discovery.",
      'FAIL (competent): "People usually threaten others with the loss they\'d fear most themselves."',
      'PASS (discovery): "Every threat is autobiographical." / "People don\'t invent fears. They export them." — then prove it.',
      "APPROACH DIVERSITY: same mechanism, different doors. Do NOT always open with \"It isn't really about X…\".",
      "Openings: Discovery / Observation / Contradiction / Image / Irony / Reversal / Relocation (sometimes).",
      "Endings: punch, drift, or stop — not always \"revealing the speaker.\"",
      'FAIL (formula): every EI reply = relocate → explain mechanism → reveal speaker.',
      'FAIL (architecture leak): "stops functioning as leverage… where the speaker\'s own boundary sits."',
